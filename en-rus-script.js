document.addEventListener("DOMContentLoaded", function() {
    ...
    const translations = {
        ...
        "ru": {
            ...
            "expertiselastline": "Я горжусь своей {{br}} профессиональностью, пунктуальностью и индивидуальным подходом к каждому проекту. Моя цель — сделать опыт каждого клиента беззаботным и беспроблемным. Позвольте мне помочь вам с вашим следующим проектом — ваше удовлетворение является моим приоритетом!",
            ...
            "notification": "Ваш запрос принят.<br> Наша команда свяжется с вами как можно скорее.",
            "notification-error": "Ошибка: Пожалуйста, проверьте следующее:<br> Поле имени не может быть пустым <br> Адрес электронной почты должен быть действительным<br> Поле сообщения не может быть пустым",
